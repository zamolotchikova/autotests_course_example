...
# Подключаем класс Counter() модуля collections для  подсчета количества входов в списке
from collections import Counter


def letter_stat(our_str):
    # Создаем словарь, содержащий в себе в качестве ключа букву,
    # в качестве значения - количество входов этой буквы в списке
